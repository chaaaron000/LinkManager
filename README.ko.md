...
Tauri, React, TypeScript, Rust로 만든 Windows 폴더 심볼릭 링크 관리 프로그램입니다.
...
- 이미 존재하는 심볼릭 링크를 수동으로 추가할 수 있습니다.
- 루트 폴더를 스캔해서 발견된 디렉터리 심볼릭 링크를 가져올 수 있습니다.
...
이미 존재하는 링크를 추가하려면 `기존 링크 추가`를 클릭합니다. 단일 링크를 선택하거나 루트 폴더를 스캔해서 디렉터리 심볼릭 링크를 가져올 수 있습니다.

`보관 루트` 탭에서는 기본 보관 루트를 저장할 수 있습니다. 대상 폴더가 이 루트 밖에 있는 링크는 해당 탭에서 원본 경로 미러링 구조에 맞춰 보관 루트 안으로 이동할 수 있습니다.
